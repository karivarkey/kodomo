...
const IneterestCard = ({ title, interetsts, setInterests, values }) => {
  ...
  return (
    <div className="bg-[#FFDADA] rounded-xl min-h-32 border-2 border-black flex flex-col  pb-5">
      ...
      <div className="flex flex-wrap gap-5 px-1 justify-evenly py-1 items-center ">
        {array.map((item, key) => (
          <button
            className={`text-[10px] rounded-xl p-2  text-center font-black font-mont border-2 border-black ${
